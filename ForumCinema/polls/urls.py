...
urlpatterns = [
    ...
    path('edit/choice/<int:choice_id>/<int:group>', views.choice_edit, name='choice_edit'),
    path('delete/choice/<int:choice_id>/<int:group>',views.choice_delete, name='choice_delete'),
